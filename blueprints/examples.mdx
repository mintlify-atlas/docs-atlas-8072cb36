...
description: "Gallery of ready-to-use Moodle Playground blueprints: minimal setup, courses with content, multi-user, plugin install, themes, roles, cohorts, and PR overlays."
---
