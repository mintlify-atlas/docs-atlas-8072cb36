---
title: "Run Moodle Playground Locally"
sidebarTitle: "Local Development"
description: "Clone and run Moodle Playground on your machine: build the PHP worker, generate Moodle bundles, start the dev server, and use the native PHP server for debugging."
---
